...
> Note: This DriveTrain uses _only_ falcons for driving. It is different for other types of motors; this is on purpose. You will not be able to find answers to every single task you will have just by looking up the docs. You need to learn the ideas behind it here and then be able to apply it anywhere.
___
### Starting point
Make sure you have 2022 of WPILib and create a new command-based project. When you do that you should end up with a file tree like the one shown.       
